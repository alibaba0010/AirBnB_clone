...
class HBNBCommand_prompt(unittest.TestCase):
    """Unittests for testing prompt of the HBNB command interpreter."""
...
class HBNBCommand_help(unittest.TestCase):
...
class HBNBCommand_exit(unittest.TestCase):
...
class HBNBCommand_update(unittest.TestCase):
...
class HBNBCommand_count(unittest.TestCase):
